                ...
                <div class="form-wrap">
                  ...
                  >
                    ...
                    <div class="wrapper-heading" v-else>
                      ...
                      <p class="fw-500">
                        Welcome to the certificate activation process
                      </p>
                ...
                <div class="vs-row">
                  <div class="vs-sm-12">
                    <div class="txt-wraper mt-2 mb-1" v-if="step.step1 == true">
                      <p>
                        Note: Additional identification procedure based on Id
                        card,previously stored certificates, boimetrical
                        parameters, graphometic signature or live operator could
                        be required
                      </p>
                    </div>
                    <div class="txt-wraper mt-2 mb-2" v-if="step.step2 == true">
                      <p>
                        Note: If you don't want to generate a new unique secure
                        password, then use a strong password with at least 12
                        characters, at least two capital letters and at least
                        one number and jolly character
                      </p>
                    </div>
                    <div class="txt-wraper mt-2 mb-2" v-if="step.step3 == true">
                      <p>
                        Note: Be sure to have full access to the email account
                        you declared during account creation. You will recive
                        all resuming information and codes to revoke, suspend or
                        renew your certificate in that inbox.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="vs-sm-12">
                    <div class="mt-4 mb-5">
                      <h6 v-if="step.step1 === true">
                        Warning: Activation procedure can be performed only if
                        you have exclusive control of codes and complete access
                        to the required tools
                      </h6>
                      <h6 v-if="step.step2 === true">
                        Warning: Accordingly with international security
                        policies, weeks password will not been accepted.
                      </h6>
                    </div>
                  </div>
                </div>
